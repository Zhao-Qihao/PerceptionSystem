...
private:
  ...
  void subCallbackCloudIn5(sensor_msgs::PointCloud2 msg);
  void subCallbackCloudIn6(sensor_msgs::PointCloud2 msg);
  ...
  std::string livox_target_;
  std::string robosense_target_;
  bool use_custom_;
  int param_clouds_;
  double param_hz_;

  // Publisher and subscribers
  ros::Subscriber sub_cloud_in1 = nh_.subscribe("/l1_points", 1, &PointcloudConcatenate::subCallbackCloudIn1, this);
  ros::Subscriber sub_cloud_in2 = nh_.subscribe("/l2_points", 1, &PointcloudConcatenate::subCallbackCloudIn2, this);
  ros::Subscriber sub_cloud_in3 = nh_.subscribe("/l3_points", 1, &PointcloudConcatenate::subCallbackCloudIn3, this);
  ros::Subscriber sub_cloud_in4 = nh_.subscribe("/l4_points", 1, &PointcloudConcatenate::subCallbackCloudIn4, this);
  ros::Subscriber sub_cloud_in5 = nh_.subscribe("/l5_points", 1, &PointcloudConcatenate::subCallbackCloudIn5, this);
  ros::Subscriber sub_cloud_in6 = nh_.subscribe("/l6_points", 1, &PointcloudConcatenate::subCallbackCloudIn6, this);
  ...
  sensor_msgs::PointCloud2 cloud_in5;
  sensor_msgs::PointCloud2 cloud_in6;
  ...
  bool cloud_in5_received = false;
  bool cloud_in6_received = false;
  ...
  bool cloud_in5_received_recent = false;
  bool cloud_in6_received_recent = false;
