...
{
  ros::init (argc, argv, "Ray_Ground_Filter_1");
  ros::NodeHandle nh;
  ...
  nh.param ("ray_ground_filter_1/general_max_slope", m_RayGroundRemove.general_max_slope_, 5.0);
  nh.param ("ray_ground_filter_1/clipping_height", m_RayGroundRemove.clipping_height_, 0.3);
  nh.param ("ray_ground_filter_1/threshold_range", m_dRange_m, 30.0);
  nh.param ("ray_ground_filter_1/input_topic", input_topic, std::string("/kitti/velo/pointcloud"));
  nh.param ("ray_ground_filter_1/output_topic", output_topic, std::string("/kitti/velo/pub_rayGround"));
