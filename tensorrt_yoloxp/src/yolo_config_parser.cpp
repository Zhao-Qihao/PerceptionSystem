...
DEFINE_string(rgb, "/home/itachi/project/catkin_ws_test/src/tensorrt_yoloxp/data/t4.colormap",
              "[OPTIONAL] Path to colormap for detections");

DEFINE_string(cmap, "/home/itachi/project/catkin_ws_test/src/tensorrt_yoloxp/data/bdd100k_semseg.csv",
              "[OPTIONAL] Path to colormap for semantic segmentation"
              "");

DEFINE_string(names, "/home/itachi/project/catkin_ws_test/src/tensorrt_yoloxp/data/t4.names",
              "[OPTIONAL] Path to pre-generated calibration table. If flag is not set, a new calib "
              "table <network-type>-<precision>-calibration.table will be generated");
