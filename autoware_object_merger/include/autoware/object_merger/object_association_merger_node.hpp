...
{
public:
  explicit ObjectAssociationMergerNode(const ros::NodeHandle & nh);
  enum class PriorityMode : int { Object0 = 0, Object1 = 1, Confidence = 2 };

private:
  void objectsCallback(
    const autoware_msgs::DetectedObjectArray & input_objects0_msg,
    const autoware_msgs::DetectedObjectArray & input_objects1_msg);
