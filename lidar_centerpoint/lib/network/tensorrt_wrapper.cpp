...
{
  runtime_ = tensorrt_common::TrtUniquePtr<nvinfer1::IRuntime>(
...
bool TensorRTWrapper::createContext()
{
  ...
  context_ = tensorrt_common::TrtUniquePtr<nvinfer1::IExecutionContext>(
...
{
  auto builder = tensorrt_common::TrtUniquePtr<nvinfer1::IBuilder>(
  ...
  auto config = tensorrt_common::TrtUniquePtr<nvinfer1::IBuilderConfig>(
  ...
  auto network = tensorrt_common::TrtUniquePtr<nvinfer1::INetworkDefinition>(
...
bool TensorRTWrapper::loadEngine(const std::string & engine_path)
{
  ...
  engine_ =
    tensorrt_common::TrtUniquePtr<nvinfer1::ICudaEngine>(runtime_->deserializeCudaEngine(
