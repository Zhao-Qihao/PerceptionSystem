...
DEFINE_string(onnx, "/home/itachi/project/catkin_ws_test/src/trt-yoloxp/yolox-sPlus-T4-960x960-pseudo-finetune.onnx",
              "ONNX Path, "
              "ONNX Path");
...
DEFINE_string(v, "/home/itachi/Desktop/image-scrape/videos/drive_video.mp4",
              "Video Path, "
              "Video Path");
...
DEFINE_string(rgb, "/home/itachi/project/catkin_ws_test/src/tensorrt_yolotfl/data/t4.colormap",
              "[OPTIONAL] Path to colormap for detections");

DEFINE_string(cmap, "/home/itachi/project/catkin_ws_test/src/tensorrt_yolotfl/data/bdd100k_semseg.csv",
              "[OPTIONAL] Path to colormap for semantic segmentation"
              "");

DEFINE_string(names, "/home/itachi/project/catkin_ws_test/src/tensorrt_yolotfl/data/t4.names",
              "[OPTIONAL] Path to pre-generated calibration table. If flag is not set, a new calib "
              "table <network-type>-<precision>-calibration.table will be generated");
...
get_colormap(const std::string rgbfile_path)
{
  std::string filename = rgbfile_path;
...
get_names(std::string classname_path)
{
  std::string filename = classname_path;
